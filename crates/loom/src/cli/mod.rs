...
pub fn bindings() -> Vec<CliBinding> {
    vec![
        ...
        bind::<sessions::github::access::list::List>(),
        ...
        bind::<sessions::scratch::delete::Delete>(),
        bind::<sessions::scratch::limits::Limits>(),
        bind::<sessions::scratch::list::List>(),
        ...
        bind::<sessions::summary::list::List>(),
        bind::<sessions::tags::delete::Delete>(),
        bind::<sessions::tags::list::List>(),
        bind::<sessions::tags::replace::Replace>(),
